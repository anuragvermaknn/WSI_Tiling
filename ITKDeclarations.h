...
typedef itk::GrayscaleMorphologicalOpeningImageFilter< CharImageType, CharImageType, CharStructuringElementType>	CharGrayscaleOpeningImageFilterType;
typedef itk::GrayscaleMorphologicalOpeningImageFilter< FloatImageType, FloatImageType, FloatStructuringElementType>	FloatGrayscaleOpeningImageFilterType;

#include "itkGrayScaleMorphologicalClosingImageFilter.h"
typedef itk::GrayscaleMorphologicalClosingImageFilter< CharImageType, CharImageType, CharStructuringElementType>	CharGrayscaleClosingImageFilterType;
typedef itk::GrayscaleMorphologicalClosingImageFilter< FloatImageType, FloatImageType, FloatStructuringElementType>	FloatGrayscaleClosingImageFilterType;
*/
//Segmentation
