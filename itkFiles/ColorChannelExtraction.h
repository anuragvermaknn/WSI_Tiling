...
CharImagePointer ColorChannelExtraction(RGBImagePointer rgbImage, std::string outputColorSpace, int colorChannel)
{
	...
	if(outputColorSpace == std::string("XYZ"))	{
		...
		typedef itk::Accessor::RGBToXYZColorSpacePixelAccessor<CharPixelType, FloatPixelType> RGBToXYZColorSpaceAccessorType;
	...
	if(outputColorSpace ==  std::string("HSI")){
		...
		typedef itk::Accessor::RGBToHSIColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToHSIColorSpacePixelAccessor;
		typedef itk::ImageAdaptor<RGBImageType,RGBToHSIColorSpacePixelAccessor> RGBToHSIImageAdaptorType;
		RGBToHSIImageAdaptorType::Pointer rgbToHSIAdaptor = RGBToHSIImageAdaptorType::New();
		rgbToHSIAdaptor->SetImage(rgbImage);

		typedef itk::VectorIndexSelectionCastImageFilter<RGBToHSIImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
	...
	if(outputColorSpace ==  std::string("HSL")){
		...
		typedef itk::Accessor::RGBToHSLColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToHSLColorSpacePixelAccessor;
		typedef itk::ImageAdaptor<RGBImageType,RGBToHSLColorSpacePixelAccessor> RGBToHSLImageAdaptorType;
		RGBToHSLImageAdaptorType::Pointer rgbToHSLAdaptor = RGBToHSLImageAdaptorType::New();
		rgbToHSLAdaptor->SetImage(rgbImage);

		typedef itk::VectorIndexSelectionCastImageFilter<RGBToHSLImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
	...
	if(outputColorSpace ==  std::string("HSV")){
		...
		typedef itk::Accessor::RGBToHSVColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToHSVColorSpacePixelAccessor;
		...
		typedef itk::VectorIndexSelectionCastImageFilter<RGBToHSVImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
	...
	if(outputColorSpace ==  std::string("Lab")){
		...
		typedef itk::Accessor::RGBToLabColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToLabColorSpacePixelAccessor;
		typedef itk::ImageAdaptor<RGBImageType,RGBToLabColorSpacePixelAccessor> RGBToLabImageAdaptorType;
		RGBToLabImageAdaptorType::Pointer rgbToLabAdaptor = RGBToLabImageAdaptorType::New();
		rgbToLabAdaptor->SetImage(rgbImage);

		typedef itk::VectorIndexSelectionCastImageFilter<RGBToLabImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
	...
	if (outputColorSpace == std::string("Luv")){
		...
		typedef itk::Accessor::RGBToLuvColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToLuvColorSpacePixelAccessorType;
		typedef itk::ImageAdaptor<RGBImageType,RGBToLuvColorSpacePixelAccessorType> RGBToLuvImageAdaptorType;
		RGBToLuvImageAdaptorType::Pointer rgbToLuvAdaptor = RGBToLuvImageAdaptorType::New();
		rgbToLuvAdaptor->SetImage(rgbImage);

		typedef itk::VectorIndexSelectionCastImageFilter<RGBToLuvImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
	...
	if (outputColorSpace == std::string("Yuv")){
		...
		typedef itk::Accessor::RGBToYuvColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToYuvColorSpacePixelAccessorType;
		typedef itk::ImageAdaptor<RGBImageType,RGBToYuvColorSpacePixelAccessorType> RGBToYuvImageAdaptorType;
	...
	if (outputColorSpace == std::string("YUV2")){
		...
		typedef itk::Accessor::RGBToYUV2ColorSpacePixelAccessor<CharPixelType,FloatPixelType> RGBToYUV2ColorSpacePixelAccessorType;
		typedef itk::ImageAdaptor<RGBImageType,RGBToYUV2ColorSpacePixelAccessorType> RGBToYUV2ImageAdaptorType;
		RGBToYUV2ImageAdaptorType::Pointer rgbToYUV2Adaptor = RGBToYUV2ImageAdaptorType::New();
		rgbToYUV2Adaptor->SetImage(rgbImage);

		typedef itk::VectorIndexSelectionCastImageFilter<RGBToYUV2ImageAdaptorType,FloatImageType> VectorCastFilterType;
		VectorCastFilterType::Pointer vectorCastFilter = VectorCastFilterType::New();
